  ...
  return(
      <SafeAreaView style={{flex: 1}}>
        <View style={styles.container}>
          ...
          <Image style={styles.pointImage} source={{uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT3NpH5hnWbpZD274Vof4cFxD2qhjc2CE8iMB9ronhzckW5XimS&usqp=CAU"}}></Image>
